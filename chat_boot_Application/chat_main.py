...
e = Entry(root, bg="purple2", fg=TEXT_COLOR, font=FONT, width=55)
e.place(x=20,y=600)
 
send = Button(root, text="Send", font=FONT_BOLD, bg=BG_GRAY,
              command=send).place(x=650,y=600)

defaultImg = Image.open('img.png')
...
frame1.place(x=800,y=10, height=400, width=400)
frame1.place_forget()
e1 = Entry(frame1, fg='black', font=FONT, width=55)
e1.place(x=10,y=40)
...
frame6.place(x=800,y=10, height=400, width=400)
frame6.place_forget()
e6 = Entry(frame6, fg='black', font=FONT, width=55)
e6.place(x=10,y=40)
